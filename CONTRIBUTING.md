...
When contributing to this repository, If it's a small change feel free to open a PR if it's a bigger change
please first discuss the change you wish to make via issue, discord, email, or any other method with the owners of this repository before making a change.
